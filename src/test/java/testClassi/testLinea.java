...
import com.gruppo07iz.geometrika.classi.Linea;
...
class testLinea {
    ...
    /**
     * Inizializza una nuova linea orizzontale da (0,0) a (50,0) di colore rosso prima di ogni test.
     */
    @BeforeEach
    void setUp() {
    ...
    void testCalcolaLunghezzaOrizzontale() {
        assertEquals(50.0, linea.calcolaLunghezza(), 0.0001);
    }
    ...
    */
    ...
    void testOttieniValoreDimensione() {
       assertEquals(50.0, linea.ottieniValoreDimensione(), 0.0001);
    }
    ...
    void testTrascinaLineaObliqua() {
        ...
        assertEquals(50.0, linea.calcolaLunghezza(), 0.0001); // Lunghezza invariata
    }
    ...
    void testToTextContenutoCompleto() {
        ...
        assertTrue(text.contains("SEGMENTO"));
